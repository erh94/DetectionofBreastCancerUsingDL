...
def main():
    ...
    train_df,train_classes = createTrainFrame(homedir)
    test_df,test_classes = createTestFrame(homedir)
    ...
    dataset =  MammographyDataset(train_file,homedir,imageSize)
    #test_dataset = MammographyDataset(test_file,homedir,img_resize)
...
######################## RESUME END #################################
    ...
    # checkpoint = torch.load('./models/{}/best_{}.pth.tar'.format(experimentName,prefix))
    # test_model = model
